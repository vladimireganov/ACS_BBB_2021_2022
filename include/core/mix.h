 ...
 *
 *             The control of is done by mixing roll, pitch, yaw, and
 *             throttle/break control oututs, a linear combination of which forms the
...
#define MAX_INPUTS 6	///< up to 6 control inputs (roll,pitch,yaw,x, y, z)
