...
// Servo mottor mapping
/*
	Using values in the right column
	to define the operational range (deg.)
	This map is servos limited to 90 deg.
	range (by the structure, not servos)
*/
static const int servos_deg_map_points = 3;
static double servos_deg_map[][2] = \
{	{0.0, 0.0000}, \
	{0.5, 45.000}, \
	{1.0, 90.000}};
